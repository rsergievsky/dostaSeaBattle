...
module.exports = {
  ...
  getAnswer: {
    ...
    busy: (id) => {
      ...
      return `${module.exports.players[id].name}, в эту клетку уже попали! 😗 \nПопробуй ещё раз, у тебя есть ещё ${movesLeft}`;
    },
    no_enough_moves: (id) => {
  ...
  postText: () => {
    ...
    'Раунд заканчивается, когда игрок попадает в ячейку с пиццей, игра начинается заново. В игре 50 раундов. Полные условия по ссылке: http://vk.com/@dostaevsky_ru-picca-boi';
  },
